...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
		...
		MO(2),  KC_LGUI,                    KC_LALT, LT(1, KC_SPC),	          KC_BSPC, KC_RALT,                          KC_RGUI, MO(2)
    ),

    LAYOUT(
		KC_ESC,  KC_1,      KC_2,      KC_3,      KC_4,       KC_5,             KC_7,      KC_8,     KC_9,    KC_MINS,    KC_EQL,      KC_BSLS,  KC_GRV,
		KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,          KC_4,   KC_5,    KC_6,   KC_TRNS,   KC_LBRC,   KC_QUOT,
    ...
    LAYOUT(
		KC_GRV,    KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,          KC_TRNS,   KC_TRNS,    KC_UP,     KC_TRNS,   KC_UP,   KC_BSLS,   KC_GRV,
		KC_CAPS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,          KC_TRNS,   KC_LEFT,    KC_DOWN,   KC_LEFT,  KC_RIGHT,   KC_BSLS,
